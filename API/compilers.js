...
exports.compilerArray= [ ["python","file.py","","Python",""],
			 ...
			 ["\'go run\'","file.go","","Go",""],
			 ["\'g++-7 -o /usercode/a.out\' ","file.cpp","/usercode/a.out","C/C++",""],
			 ...
			 ["gcc-7","file.m"," /usercode/a.out","Objective-C","\' -o /usercode/a.out -I/usr/include/GNUstep -L/usr/lib/GNUstep -lobjc -lgnustep-base -Wall -fconstant-string-class=NSConstantString\'"],
